...
(function (factory) {
    ...
    exports.withRetry = exports.isErrorType = exports.isAppError = exports.ErrorHandlerUtils = exports.globalErrorHandler = exports.ErrorHandler = exports.ResourceExhaustedError = exports.ValidationError = exports.BootstrapError = exports.NodeUnreachableError = exports.DHTError = exports.DataCorruptedError = exports.MetadataError = exports.HandshakeError = exports.ProtocolError = exports.DNSResolutionError = exports.ConnectionRefusedError = exports.TimeoutError = exports.NetworkError = exports.AppError = exports.ErrorSeverity = exports.ErrorType = void 0;
    ...
    class ErrorHandlerUtils {
        ...
        static safeExecuteAsync(fn, errorHandler = exports.globalErrorHandler, context = {}, defaultValue, operation) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    return yield fn();
                }
        ...
        static safeExecuteWithRetry(fn, errorHandler = exports.globalErrorHandler, maxRetries = 3, delayMs = 1000, context = {}, operation, exponentialBackoff = true) {
            return __awaiter(this, void 0, void 0, function* () {
                let lastError;
        ...
        static safeExecuteWithTimeout(fn, timeoutMs, errorHandler = exports.globalErrorHandler, context = {}, operation) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        static safeExecuteBatch(operations, errorHandler = exports.globalErrorHandler, context = {}, operation, concurrency = 3) {
            return __awaiter(this, void 0, void 0, function* () {
                const results = [];
                const errors = [];
