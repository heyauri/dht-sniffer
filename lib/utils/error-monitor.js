(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "events", "./error-handler"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.globalErrorMonitor = exports.ErrorReportGenerator = exports.ErrorMonitor = void 0;
    ...
    class ErrorMonitor extends events_1.EventEmitter {
        ...
        initErrorCount() {
            const counts = {};
            Object.values(error_handler_1.ErrorType).forEach(type => {
                counts[type] = 0;
            });
            return counts;
        }
        initSeverityCount() {
            const counts = {};
            Object.values(error_handler_1.ErrorSeverity).forEach(severity => {
                counts[severity] = 0;
            });
            return counts;
        }
        ...
        checkCriticalErrorThreshold() {
            const criticalCount = this.errorsBySeverity[error_handler_1.ErrorSeverity.CRITICAL] || 0;
