...
(function (factory) {
    ...
    class NetworkErrorRecoveryStrategy {
        ...
        canRecover(error) {
            return [
                error_types_1.ErrorType.SOCKET_ERROR,
                error_types_1.ErrorType.CONNECTION_TIMEOUT,
                error_types_1.ErrorType.CONNECTION_REFUSED,
                error_types_1.ErrorType.NETWORK_UNREACHABLE,
                error_types_1.ErrorType.DNS_RESOLUTION_FAILED
    ...
    class TimeoutErrorRecoveryStrategy {
        ...
        canRecover(error) {
            return error.type === error_types_1.ErrorType.CONNECTION_TIMEOUT && error.recoverable;
        }
        recover(error) {
            return __awaiter(this, void 0, void 0, function* () {
                const context = error.context;
    ...
    class ErrorRecoveryManager extends events_1.EventEmitter {
        ...
        initializeDefaultStrategies() {
            this.registerStrategy(error_types_1.ErrorType.SOCKET_ERROR, new NetworkErrorRecoveryStrategy());
            this.registerStrategy(error_types_1.ErrorType.CONNECTION_TIMEOUT, new TimeoutErrorRecoveryStrategy());
            this.registerStrategy(error_types_1.ErrorType.CONNECTION_REFUSED, new NetworkErrorRecoveryStrategy());
            this.registerStrategy(error_types_1.ErrorType.NETWORK_UNREACHABLE, new NetworkErrorRecoveryStrategy());
            this.registerStrategy(error_types_1.ErrorType.DNS_RESOLUTION_FAILED, new NetworkErrorRecoveryStrategy());
            this.registerStrategy(error_types_1.ErrorType.DHT_ERROR, new NetworkErrorRecoveryStrategy());
            this.registerStrategy(error_types_1.ErrorType.NODE_UNREACHABLE, new NetworkErrorRecoveryStrategy());
            this.registerStrategy(error_types_1.ErrorType.BOOTSTRAP_FAILED, new NetworkErrorRecoveryStrategy());
            this.registerStrategy(error_types_1.ErrorType.PROTOCOL_ERROR, new NetworkErrorRecoveryStrategy());
            this.registerStrategy(error_types_1.ErrorType.HANDSHAKE_FAILED, new NetworkErrorRecoveryStrategy());
        }
