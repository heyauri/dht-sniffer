...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./error-types"], factory);
    }
        ...
        static safeExecuteWithTimeout(fn_1, timeoutMs_1, errorHandler_1) {
            return __awaiter(this, arguments, void 0, function* (fn, timeoutMs, errorHandler, context = {}, operation) {
                const timeoutPromise = new Promise((_, reject) => {
                    setTimeout(() => {
                        reject(new error_types_1.TimeoutError(`Operation timed out after ${timeoutMs}ms`, Object.assign(Object.assign({}, context), { operation: operation || 'safeExecuteWithTimeout', timeoutMs })));
                    }, timeoutMs);
                });
                try {
    ...
    class ErrorFormatter {
        static formatError(error) {
            if ((0, error_types_1.isAppError)(error)) {
        ...
        static getSeverityString(severity) {
            switch (severity) {
                case error_types_1.ErrorSeverity.DEBUG: return 'DEBUG';
                case error_types_1.ErrorSeverity.INFO: return 'INFO';
                case error_types_1.ErrorSeverity.WARNING: return 'WARNING';
                case error_types_1.ErrorSeverity.ERROR: return 'ERROR';
                case error_types_1.ErrorSeverity.CRITICAL: return 'CRITICAL';
                case error_types_1.ErrorSeverity.FATAL: return 'FATAL';
