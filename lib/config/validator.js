(function (factory) {
    ...
    exports.globalConfigValidator = exports.ConfigValidatorManager = exports.ErrorConfigValidator = exports.PeerConfigValidator = exports.MetadataConfigValidator = exports.CacheConfigValidator = exports.DHTConfigValidator = exports.BaseValidator = void 0;
    ...
    class PeerConfigValidator extends BaseValidator {
        validate(config) {
            const errors = [];
            const warnings = [];
            try {
    ...
    exports.PeerConfigValidator = PeerConfigValidator;
    class ErrorConfigValidator extends BaseValidator {
        validate(config) {
            const errors = [];
            const warnings = [];
            try {
    ...
    exports.ErrorConfigValidator = ErrorConfigValidator;
