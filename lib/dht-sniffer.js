...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "events", "./core/container", "./config/validator", "./core/event-bus", "process"], factory);
    }
    ...
    class DHTSniffer extends events_1.EventEmitter {
        ...
        initializeArchitectureComponents() {
            ...
            this.container = (0, container_1.createDefaultContainer)(containerConfig);
        }
