...
class DHTSniffer extends events_1.EventEmitter {
    ...
    getSizes() {
        let fetchings = Object.keys(this.metadataFetchingDict);
        console.log(fetchings.length, this.metadataWaitingQueues.length, this.fetchdCache.keyMap.size, this.dht._tables.size, this.dht._values.size, this.dht._peers.size);
    }
