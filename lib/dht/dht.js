(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "events", "../bencode", "debug", "k-bucket", "k-rpc", "last-one-wins", "lru-cache", "randombytes", "record-cache", "crypto"], factory);
    }
    ...
    const debug = (0, debug_1.default)('bittorrent-dht');
    const ROTATE_INTERVAL = 5 * 60 * 1000;
    const BUCKET_OUTDATED_TIMESPAN = 15 * 60 * 1000;
    class DHT extends events_1.EventEmitter {
        constructor(opts = {}) {
            super();
            this._tables = new lru_cache_1.LRUCache({ ttl: ROTATE_INTERVAL, max: opts.maxTables || 1000 });
            this._values = new lru_cache_1.LRUCache({ max: opts.maxValues || 1000 });
            this._peers = records({
        ...
        _put(opts, cb) {
            ...
            const key = isMutable
                ...
                : this._hash(bencode_1.default.encode(v));
        ...
        get(key, opts, cb) {
            ...
            function onreply(message) {
                ...
                if (isMutable) {
                    ...
                    if (hash(bencode_1.default.encode(r.v)).equals(key)) {
                        value = r;
                        return false;
                    }
                }
        ...
        announce(infoHash, port, cb) {
            ...
            if (this._host) {
                ...
                this._addPeer({ host: this._host, port: port || dhtPort }, infoHash, { host: this._host, port: dhtPort });
            }
            const message = {
                q: 'announce_peer',
                a: {
    ...
    function encodeSigData(msg) {
        ...
        if (msg.salt)
            ref.salt = msg.salt;
        return bencode_1.default.encode(ref).slice(1, -1);
    }
