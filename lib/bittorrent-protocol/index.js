...
(function (factory) {
    ...
    const unordered_array_remove_1 = require("unordered-array-remove");
    const debug = (0, debug_1.default)('bittorrent-protocol');
    ...
    class Wire extends streamx_1.Duplex {
        constructor(type = null, retries = 0, peEnabled = false) {
            ...
            this.peerPieces = new bitfield_1.default(0, { grow: BITFIELD_GROW });
            this.extensions = {};
            this.peerExtensions = {};
            this.requests = [];
            this.peerRequests = [];
            ...
            this.uploaded = 0;
            this.downloaded = 0;
            this.uploadSpeed = (0, throughput_1.default)();
            this.downloadSpeed = (0, throughput_1.default)();
            ...
            if (peEnabled) {
                this._dh = crypto_1.default.createDiffieHellman(DH_PRIME, 'hex', DH_GENERATOR);
        ...
        setEncrypt(sharedSecret, infoHash) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const keyAGenerator = new rc4_1.default([...yield (0, uint8_util_1.hash)((0, uint8_util_1.hex2arr)(this._utfToHex('keyA') + sharedSecret + infoHash))]);
                const keyBGenerator = new rc4_1.default([...yield (0, uint8_util_1.hash)((0, uint8_util_1.hex2arr)(this._utfToHex('keyB') + sharedSecret + infoHash))]);
        ...
        _pull(requests, piece, offset, length) {
            for (let i = 0; i < requests.length; i++) {
                ...
                if (req.piece === piece && req.offset === offset && req.length === length) {
                    (0, unordered_array_remove_1.default)(requests, i);
                    return req;
                }
            }
            return null;
