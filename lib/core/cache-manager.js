...
(function (factory) {
    ...
    class CacheManager extends base_manager_1.BaseManager {
        constructor(config, errorHandler) {
            ...
            const findNodeCacheConfig = Object.assign(Object.assign({}, cacheAccessConfig), { cacheName: 'findNodeCache' });
            this.findNodeCacheHelper = cache_access_helper_1.CacheAccessHelperFactory.getHelper(this.errorHandler, findNodeCacheConfig);
            const latestCalledPeersConfig = Object.assign(Object.assign({}, cacheAccessConfig), { cacheName: 'latestCalledPeers' });
            this.latestCalledPeersHelper = cache_access_helper_1.CacheAccessHelperFactory.getHelper(this.errorHandler, latestCalledPeersConfig);
            const usefulPeersConfig = Object.assign(Object.assign({}, cacheAccessConfig), { cacheName: 'usefulPeers' });
            this.usefulPeersHelper = cache_access_helper_1.CacheAccessHelperFactory.getHelper(this.errorHandler, usefulPeersConfig);
            const metadataFetchingConfig = Object.assign(Object.assign({}, cacheAccessConfig), { cacheName: 'metadataFetchingCache' });
            this.metadataFetchingHelper = cache_access_helper_1.CacheAccessHelperFactory.getHelper(this.errorHandler, metadataFetchingConfig);
            this.counter = {
                fetchedTupleHit: 0,
