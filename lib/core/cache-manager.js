...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "lru-cache", "../types/error", "./base-manager"], factory);
    }
    ...
    class CacheManager extends base_manager_1.BaseManager {
        ...
        executeWithCircuitBreaker(cacheName, key, operation) {
        ...
        getCircuitBreakerState(key) {
            ...
            const state = this.circuitBreakerState.get(key) || { failures: 0, lastFailure: 0, state: 'CLOSED' };
        ...
        handleCircuitBreakerFailure(key, state) {
            state.failures++;
