(function (factory) {
    ...
    exports.globalContainer = exports.createDefaultContainer = exports.DIContainer = void 0;
    ...
    function createDefaultContainer(config) {
        ...
        container.register('dhtManager', () => {
            ...
            return new dht_manager_1.DHTManager(Object.assign(Object.assign({}, dhtConfig), { enableErrorHandling: true, enableMemoryMonitoring: true }), errorHandler, peerManager);
        }, true);
        return container;
    }
