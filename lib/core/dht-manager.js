...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "crypto", "../dht/dht", "../utils/dht-utils", "../types/error", "./base-manager"], factory);
    }
    ...
    class DHTManager extends base_manager_1.BaseManager {
        ...
        findNode(peer, nodeId) {
            if (!this.dht || !this.isDHTRunning())
                return;
            try {
                const nodeKey = (0, dht_utils_1.getPeerKey)(peer);
                const target = nodeId !== undefined
                    ? (0, dht_utils_1.getNeighborId)(nodeId, this.dht.nodeId)
                    : this.dht.nodeId;
                const message = {
                ...
                this.dht._rpc.query(peer, message, (err, reply) => {
                    try {
                        if (peer && peer.id && this.dht._rpc.nodes.get(peer.id) && (0, dht_utils_1.isNodeId)(peer.id, 20)) {
                    ...
                    if (reply && reply.r && reply.r.nodes) {
                        const nodes = (0, dht_utils_1.parseNodes)(reply.r.nodes, 20);
                        for (const node of nodes) {
                            if ((0, dht_utils_1.isNodeId)(node.id, 20)) {
