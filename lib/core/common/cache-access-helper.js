...
(function (factory) {
    ...
    class CacheAccessHelper {
        ...
        getWithRetry(cache_1, key_1) {
            return __awaiter(this, arguments, void 0, function* (cache, key, operation = 'cache_access') {
        ...
        setWithRetry(cache_1, key_1, value_1, ttl_1) {
            return __awaiter(this, arguments, void 0, function* (cache, key, value, ttl, operation = 'cache_set') {
                return this.executeWithRetry(() => __awaiter(this, void 0, void 0, function* () {
                    if (ttl) {
        ...
        batchGet(cache_1, keys_1) {
            return __awaiter(this, arguments, void 0, function* (cache, keys, operation = 'batch_cache_get') {
        ...
        batchSet(cache_1, entries_1) {
            return __awaiter(this, arguments, void 0, function* (cache, entries, operation = 'batch_cache_set') {
                const promises = entries.map((_a) => __awaiter(this, [_a], void 0, function* ({ key, value, ttl }) {
                    try {
