(function (factory) {
    ...
    exports.EventListenerFactory = void 0;
    ...
    class EventListenerFactory {
        static createErrorListener(errorHandler, managerName, errorContext) {
            return {
                event: 'error',
                handler: (error) => {
                    errorHandler.handleError(error, Object.assign({ manager: managerName, operation: 'event_listener' }, errorContext));
                }
            };
        }
        static createWarningListener(errorHandler, managerName) {
            return {
                event: 'warning',
                handler: (warning) => {
        ...
        static createPerformanceWarningListener(errorHandler, managerName) {
            return {
        ...
        static createMemoryCleanupListener(errorHandler, managerName) {
            return {
                event: 'memoryCleanup',
                handler: (cleanup) => {
        ...
        static createRetryListener(errorHandler, managerName) {
            return {
                event: 'retry',
                handler: (event) => {
