(function (factory) {
    ...
    function withErrorHandling(Base) {
        return class extends Base {
            ...
            normalizeError(error, errorType) {
            ...
            attemptErrorRecovery(error, operation, context) {
    ...
    class ErrorHandlingDecorator {
        static create(errorHandler, operation, errorType = error_1.ErrorType.SYSTEM, context) {
