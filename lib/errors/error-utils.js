...
(function (factory) {
    ...
    class ErrorHandlerUtils {
        ...
        static safeExecuteAsync(fn, errorHandler, context = {}, defaultValue, operation) {
        ...
        static safeExecuteWithRetry(fn, errorHandler, maxRetries = 3, delayMs = 1000, context = {}, operation, exponentialBackoff = true) {
            return __awaiter(this, void 0, void 0, function* () {
                let lastError;
        ...
        static safeExecuteWithTimeout(fn, timeoutMs, errorHandler, context = {}, operation) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        static safeExecuteBatch(operations, errorHandler, context = {}, operation, concurrency = 3) {
            return __awaiter(this, void 0, void 0, function* () {
                const results = [];
                const errors = [];
